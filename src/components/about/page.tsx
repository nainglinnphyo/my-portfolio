...
function About() {
     return (
          <div className='h-ful md:pt-28 pt-20 justify-between flex flex-col md:px-52 px-10 -z-50 md:w-[75%] md:space-y-8 space-y-8'>
